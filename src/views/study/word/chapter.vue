    ...
    <el-row :gutter="18">
      ...
      <el-col v-show="dialogResult" :span="10" :offset="7">
        <div class="grid-content bg-purple">
          ...
          <div class="btn-box">
            <el-button type="primary" round @click="reChapter()">重新学习</el-button>
          </div>
        </div>
      </el-col>
    </el-row>
...
<script>
import { selectWordDetail, addStudyLog } from '@/api/study'
...
export default {
  ...
  methods: {
    fetchData() {
      selectWordDetail(this.chapterId).then(response => {
